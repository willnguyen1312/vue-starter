  ...
  <section class="keyboard-section">
    ...
    >
      <button
        ...
        :class="{
          absent: letterGuessState[char] === LETTER_GUESS_STATE.ABSENT,
          correct: letterGuessState[char] === LETTER_GUESS_STATE.CORRECT,
          present: letterGuessState[char] === LETTER_GUESS_STATE.PRESENT,
        }"
      >
        {{
          (() => {
